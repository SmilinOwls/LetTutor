...
class MergeInputDecoration {
  static InputDecoration merge(InputDecoration input1, InputDecoration? input2) {
    if (input2 == null) {
      return input1;
    }
    return input1.copyWith(
      alignLabelWithHint: input2.alignLabelWithHint ?? input1.alignLabelWithHint,
      ...
      floatingLabelBehavior: input2.floatingLabelBehavior ?? input1.floatingLabelBehavior,
      floatingLabelStyle: input2.floatingLabelStyle ?? input1.floatingLabelStyle,
      focusColor: input2.focusColor ?? input1.focusColor,
      focusedBorder: input2.focusedBorder ?? input1.focusedBorder,
      focusedErrorBorder: input2.focusedErrorBorder ?? input1.focusedErrorBorder,
      ...
      prefixIconConstraints: input2.prefixIconConstraints ?? input1.prefixIconConstraints,
      prefixStyle: input2.prefixStyle ?? input1.prefixStyle,
      prefixText: input2.prefixText ?? input1.prefixText,
      semanticCounterText: input2.semanticCounterText ?? input1.semanticCounterText,
      ...
      suffixIconConstraints: input2.suffixIconConstraints ?? input1.suffixIconConstraints ,
